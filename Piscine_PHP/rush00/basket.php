...
<html>
	<head>
		<title>Gogol's Cafe - Basket</title>
		<meta name="Author" content="crath, dmorar" />
		<meta name="Description" content="Rush00" />
			...
			<div id="left-panel">
				...
				<?php
					if ($_SESSION['basket'] != NULL)
					{
						...
						{
							$article = str_replace("_", " ", $article_name);
							$price = get_price($article, $quantity);
							$total_price += $price;
						}
						echo '<div class="order-block">';
						echo '<h4>'.$total_price.'€<h4><br />';
						echo '</div>';
